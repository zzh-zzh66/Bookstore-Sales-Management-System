        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="btn-group mb-3">
                    ...
                    <a href="/lms/report/monthly" class="btn btn-primary">月报</a>
                    <a href="/lms/report/bestseller" class="btn btn-outline-primary">畅销书</a>
                </div>

                <div class="card mb-3">
                    <div class="card-body">
                        <form method="get" action="/lms/report/monthly" class="row g-3">
                            <div class="col-md-4">
