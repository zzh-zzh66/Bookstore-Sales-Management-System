        ...
        <div class="row">
            <div class="col-md-2">
                <div class="list-group">
                    ...
                    <a href="/lms/config/list" class="list-group-item list-group-item-action active">系统设置</a>
                </div>
            </div>
            <div class="col-md-10">
                <h3>系统设置</h3>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach items="${page.records}" var="config">
                            <tr>
                                <td>${config.configKey}</td>
                                <td>${config.configValue}</td>
                                <td>${config.description}</td>
                                <td>
                                    <button class="btn btn-sm btn-primary" onclick="editConfig('${config.configId}', '${config.configValue}')">编辑</button>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
